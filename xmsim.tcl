...
probe -create -shm :cpu:esp_1:tiles_gen(5):cpu_tile:tile_cpu_i:with_cache_coherence:l2_wrapper_1:l2_spandex_gen:l2_cache_i -all -waveform

probe -create -shm :cpu:esp_1:tiles_gen(3):mem_tile:tile_mem_i:with_cache_coherence:llc_wrapper_1:llc_spandex_gen:llc_cache_i -all -waveform
