...
probe -create -shm :cpu:esp_1:tiles_gen(5):cpu_tile:tile_cpu_i:with_cache_coherence:l2_wrapper_1:l2_spandex_gen:l2_cache_i -waveform

probe -create -shm :cpu:esp_1:tiles_gen(6):accelerator_tile:tile_acc_i:fft_stratus_gen:noc_fft_stratus_i -waveform

probe -create -shm :cpu:esp_1:tiles_gen(6):accelerator_tile:tile_acc_i:fft_stratus_gen:noc_fft_stratus_i:l2_gen:l2_acc_wrapper_1:l2_spandex_gen:l2_cache_i -waveform

probe -create -shm :cpu:esp_1:tiles_gen(7):accelerator_tile:tile_acc_i:vitdodec_stratus_gen:noc_vitdodec_stratus_i -waveform

probe -create -shm :cpu:esp_1:tiles_gen(7):accelerator_tile:tile_acc_i:vitdodec_stratus_gen:noc_vitdodec_stratus_i:l2_gen:l2_acc_wrapper_1:l2_spandex_gen:l2_cache_i -waveform
...
probe -create -shm :cpu:esp_1:tiles_gen(4):accelerator_tile:tile_acc_i:sensor_dma_stratus_gen:noc_sensor_dma_stratus_i:l2_gen:l2_acc_wrapper_1:l2_spandex_gen:l2_cache_i -waveform
