...
probe -create -shm :cpu:esp_1:tiles_gen(1):cpu_tile:tile_cpu_i:ariane_cpu_gen:ariane_axi_wrap_1:ariane_wrap_1.i_ariane.commit_stage_i.commit_instr_i -waveform
probe -create -shm :cpu:esp_1:tiles_gen(2):cpu_tile:tile_cpu_i:ariane_cpu_gen:ariane_axi_wrap_1:ariane_wrap_1.i_ariane.commit_stage_i.commit_instr_i -waveform
