...
def write_acc_interface(f, acc, dma_width, datatype, rst, is_vivadohls_if, is_catapulthls_cxx_if, is_catapulthls_sysc_if):
  ...
  if is_catapulthls_cxx_if:
    ...
    f.write("      dma_read_ctrl_data_opts_dcs_en          : out std_ulogic;\n")
    f.write("      dma_read_ctrl_data_opts_use_owner_pred  : out std_ulogic;\n")
    f.write("      dma_read_ctrl_data_opts_dcs             : out std_logic_vector(1 downto 0);\n")
    f.write("      dma_read_ctrl_data_opts_pred_cid        : out std_logic_vector(3 downto 0);\n")
    ...
    f.write("      dma_write_ctrl_data_opts_dcs_en         : out std_ulogic;\n")
    f.write("      dma_write_ctrl_data_opts_use_owner_pred : out std_ulogic;\n")
    f.write("      dma_write_ctrl_data_opts_dcs            : out std_logic_vector(1 downto 0);\n")
    f.write("      dma_write_ctrl_data_opts_pred_cid       : out std_logic_vector(3 downto 0);\n")
...
def write_acc_port_map(f, acc, dma_width, datatype, rst, is_noc_interface, is_vivadohls_if, is_catapulthls_cxx_if, is_catapulthls_sysc_if):
  ...
  if is_vivadohls_if:
    ...
    f.write("      dma_read_ctrl_data_opts_dcs_en          => dma_read_ctrl_data_opts_dcs_en,\n")
    f.write("      dma_read_ctrl_data_opts_use_owner_pred  => dma_read_ctrl_data_opts_use_owner_pred,\n")
    f.write("      dma_read_ctrl_data_opts_dcs             => dma_read_ctrl_data_opts_dcs,\n")
    f.write("      dma_read_ctrl_data_opts_pred_cid        => dma_read_ctrl_data_opts_pred_cid,\n")
    ...
    f.write("      dma_write_ctrl_data_opts_dcs_en         => dma_write_ctrl_data_opts_dcs_en,\n")
    f.write("      dma_write_ctrl_data_opts_use_owner_pred => dma_write_ctrl_data_opts_use_owner_pred,\n")
    f.write("      dma_write_ctrl_data_opts_dcs            => dma_write_ctrl_data_opts_dcs,\n")
    f.write("      dma_write_ctrl_data_opts_pred_cid       => dma_write_ctrl_data_opts_pred_cid,\n")
