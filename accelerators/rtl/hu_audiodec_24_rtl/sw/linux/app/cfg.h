...
struct hu_audiodec_24_rtl_access hu_audiodec_24_cfg_000[] = {
	{
		/* <<--descriptor-->> */
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "hu_audiodec_24_rtl.0",
		.ioctl_req = HU_AUDIODEC_24_RTL_IOC_ACCESS,
		.esp_desc = &(hu_audiodec_24_cfg_000[0].esp),
	}
};
