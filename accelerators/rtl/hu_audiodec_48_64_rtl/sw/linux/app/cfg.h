...
struct hu_audiodec_48_64_rtl_access hu_audiodec_48_64_cfg_000[] = {
	{
		/* <<--descriptor-->> */
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "hu_audiodec_48_64_rtl.0",
		.ioctl_req = HU_AUDIODEC_48_64_RTL_IOC_ACCESS,
		.esp_desc = &(hu_audiodec_48_64_cfg_000[0].esp),
	}
};
