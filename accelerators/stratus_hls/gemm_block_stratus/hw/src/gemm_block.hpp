...
#ifndef __GEMM_BLOCK_HPP__
#define __GEMM_BLOCK_HPP__
...
class gemm_block : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemm_block);
    gemm_block(const sc_module_name& name)
