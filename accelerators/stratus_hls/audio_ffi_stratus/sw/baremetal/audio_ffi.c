...
int main(int argc, char * argv[])
{
	...
	n = 0;
	{
		...
		///////////////////////////////////////////////////////
		iowrite32(dev, AUDIO_FFI_LOGN_SAMPLES_REG_0, logn_samples);
		iowrite32(dev, AUDIO_FFI_DO_SHIFT_REG_0, do_shift);
		iowrite32(dev, AUDIO_FFI_INPUT_QUEUE_BASE_0, input_valid_offset_0);
		iowrite32(dev, AUDIO_FFI_OUTPUT_QUEUE_BASE_0, output_valid_offset_0);
		iowrite32(dev, AUDIO_FFI_FILTER_QUEUE_BASE_0, filter_valid_offset_0);
		iowrite32(dev, AUDIO_FFI_CONTEXT_QUOTA, 50000);
		iowrite32(dev, AUDIO_FFI_VALID_CONTEXTS, 0x1);
		...
		///////////////////////////////////////////////////////
		iowrite32(dev, AUDIO_FFI_LOGN_SAMPLES_REG_1, logn_samples);
		iowrite32(dev, AUDIO_FFI_DO_SHIFT_REG_1, do_shift);
		iowrite32(dev, AUDIO_FFI_INPUT_QUEUE_BASE_1, input_valid_offset_1);
		iowrite32(dev, AUDIO_FFI_OUTPUT_QUEUE_BASE_1, output_valid_offset_1);
		iowrite32(dev, AUDIO_FFI_FILTER_QUEUE_BASE_1, filter_valid_offset_1);
		iowrite32(dev, AUDIO_FFI_VALID_CONTEXTS, 0x3);
		...
		///////////////////////////////////////////////////////
		iowrite32(dev, AUDIO_FFI_LOGN_SAMPLES_REG_2, logn_samples);
		iowrite32(dev, AUDIO_FFI_DO_SHIFT_REG_2, do_shift);
		iowrite32(dev, AUDIO_FFI_INPUT_QUEUE_BASE_2, input_valid_offset_2);
		iowrite32(dev, AUDIO_FFI_OUTPUT_QUEUE_BASE_2, output_valid_offset_2);
		iowrite32(dev, AUDIO_FFI_FILTER_QUEUE_BASE_2, filter_valid_offset_2);
		iowrite32(dev, AUDIO_FFI_VALID_CONTEXTS, 0x7);
