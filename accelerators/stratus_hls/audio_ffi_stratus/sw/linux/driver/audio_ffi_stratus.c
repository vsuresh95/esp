...
/* <<--regs-->> */
#define AUDIO_FFI_DO_SHIFT_REG_0		0x70
#define AUDIO_FFI_DO_SHIFT_REG_1		0x74
#define AUDIO_FFI_DO_SHIFT_REG_2		0x78
#define AUDIO_FFI_DO_SHIFT_REG_3		0x7C
#define AUDIO_FFI_LOGN_SAMPLES_REG_0	0x80
#define AUDIO_FFI_LOGN_SAMPLES_REG_1	0x84
#define AUDIO_FFI_LOGN_SAMPLES_REG_2	0x88
#define AUDIO_FFI_LOGN_SAMPLES_REG_3	0x8C
#define AUDIO_FFI_INPUT_QUEUE_BASE_0	0x90
#define AUDIO_FFI_INPUT_QUEUE_BASE_1	0x94
#define AUDIO_FFI_INPUT_QUEUE_BASE_2	0x98
#define AUDIO_FFI_INPUT_QUEUE_BASE_3	0x9C
#define AUDIO_FFI_OUTPUT_QUEUE_BASE_0	0xA0
#define AUDIO_FFI_OUTPUT_QUEUE_BASE_1	0xA4
#define AUDIO_FFI_OUTPUT_QUEUE_BASE_2	0xA8
#define AUDIO_FFI_OUTPUT_QUEUE_BASE_3	0xAC
#define AUDIO_FFI_FILTER_QUEUE_BASE_0	0xB0
#define AUDIO_FFI_FILTER_QUEUE_BASE_1	0xB4
#define AUDIO_FFI_FILTER_QUEUE_BASE_2	0xB8
#define AUDIO_FFI_FILTER_QUEUE_BASE_3	0xBC
#define AUDIO_FFI_CONTEXT_QUOTA_0		0xC0
#define AUDIO_FFI_CONTEXT_QUOTA_1		0xC4
#define AUDIO_FFI_CONTEXT_QUOTA_2		0xC8
#define AUDIO_FFI_CONTEXT_QUOTA_3		0xCC
#define AUDIO_FFI_VALID_CONTEXTS		0xD0
...
static void audio_ffi_init_accel(struct esp_device *esp, void *arg)
{
	...
	// iowrite32be(a->esp.context_quota, esp->iomem + AUDIO_FFI_CONTEXT_QUOTA_0 + 0x4*esp->context_id);
	iowrite32be(a->esp.valid_contexts, esp->iomem + AUDIO_FFI_VALID_CONTEXTS);
}
