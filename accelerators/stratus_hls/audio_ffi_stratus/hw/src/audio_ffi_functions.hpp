...
inline void audio_ffi::compute_util_ready_handshake()
{
    {
...
inline void audio_ffi::util_compute_ready_handshake()
{
    {
...
inline void audio_ffi::compute_util_done_handshake()
{
    {
...
inline void audio_ffi::util_compute_done_handshake()
{
    {
