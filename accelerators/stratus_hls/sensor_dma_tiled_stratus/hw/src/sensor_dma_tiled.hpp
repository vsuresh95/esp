...
#ifndef __SENSOR_DMA_TILED_HPP__
#define __SENSOR_DMA_TILED_HPP__
...
public:
    // Constructor
    SC_HAS_PROCESS(sensor_dma_tiled);
    sensor_dma_tiled(const sc_module_name& name)
...
#endif /* __SENSOR_DMA_TILED_HPP__ */
