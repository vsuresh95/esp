...
#ifndef __BASIC_256_GEMM_HPP__
#define __BASIC_256_GEMM_HPP__
...
class basic_256_gemm : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(basic_256_gemm);
    basic_256_gemm(const sc_module_name& name)
