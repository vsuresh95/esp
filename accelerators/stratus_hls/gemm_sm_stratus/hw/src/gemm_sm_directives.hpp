...
#ifndef __GEMM_SM_DIRECTIVES_HPP__
#define __GEMM_SM_DIRECTIVES_HPP__

#define DMA_BEAT_PER_WORD 1
#define DMA_WORD_PER_BEAT 2
#define PLM_IN_NAME "gemm_sm_plm_block_in_dma64"
#define PLM_OUT_NAME "gemm_sm_plm_block_out_dma64"
...
#endif /* __GEMM_SM_DIRECTIVES_HPP_ */
