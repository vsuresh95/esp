...
int main(int argc, char **argv)
{
    ...
    gemm_sm_cfg_000[0].esp.coherence = coherence;
	gemm_sm_cfg_000[0].spandex_conf = spandex_config.spandex_reg;
	...
	gemm_sm_cfg_000[0].prod_valid_offset = local_cons_vld_flag_offset;
	gemm_sm_cfg_000[0].prod_ready_offset = local_cons_rdy_flag_offset;
	gemm_sm_cfg_000[0].cons_valid_offset = local_prod_vld_flag_offset;
	gemm_sm_cfg_000[0].cons_ready_offset = local_prod_rdy_flag_offset;
	gemm_sm_cfg_000[0].input_offset = SYNC_VAR_SIZE;
	gemm_sm_cfg_000[0].output_offset = in_len + SYNC_VAR_SIZE;
    ...
    gemm_sm_cfg_000[0].esp.start_stop = 1;
