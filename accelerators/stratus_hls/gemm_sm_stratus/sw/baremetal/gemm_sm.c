...
int main(int argc, char * argv[])
{
	...
	///////////////////////////////////////////////////////
	iowrite32(dev, GEMM_SM_CONTEXT_BASE_PTR_0, stat_offset);
	...
	iowrite32(dev, GEMM_SM_SCHED_PERIOD, 0x100000);

	// Set up two descriptors: 1 GEMM_SM, 1 JUMP
	...
	///////////////////////////////////////////////////////
	iowrite32(dev, GEMM_SM_CONTEXT_BASE_PTR_1, stat_offset);
	...
	///////////////////////////////////////////////////////
	iowrite32(dev, GEMM_SM_CONTEXT_BASE_PTR_2, stat_offset);
	...
	/// Configure second context
	///////////////////////////////////////////////////////
	iowrite32(dev, GEMM_SM_CONTEXT_BASE_PTR_3, stat_offset);
