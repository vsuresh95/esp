...
#ifndef __GEMM_0_BLOCK_HPP__
#define __GEMM_0_BLOCK_HPP__

#include "gemm_0_block_conf_info.hpp"
#include "gemm_0_block_debug_info.hpp"
...
class gemm_0_block : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemm_0_block);
    gemm_0_block(const sc_module_name& name)
