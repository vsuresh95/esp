...
#ifndef __AUDIO_FIR_PIPELINED_HPP__
#define __AUDIO_FIR_PIPELINED_HPP__
...
public:
    ...
    // Filters ASI -> Compute
    handshake_t filters_to_compute;
    ...
    : esp_accelerator_3P<DMA_WIDTH>(name)
        ...
        , filters_to_compute("filters_to_compute")
        , compute_to_output("compute_to_output")
    {
        ...
        filters_to_compute.bind_with(*this);
    ...
    inline void filters_compute_handshake();
    inline void compute_filters_handshake();
    inline void compute_output_handshake();
    inline void output_compute_handshake();
};


#endif /* __AUDIO_FIR_PIPELINED_HPP__ */
