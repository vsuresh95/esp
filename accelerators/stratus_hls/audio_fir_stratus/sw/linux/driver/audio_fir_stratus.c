...
/* <<--regs-->> */
#define AUDIO_FIR_LOGN_SAMPLES_REG 0x40
#define AUDIO_FIR_INPUT_QUEUE_BASE 0X44
#define AUDIO_FIR_OUTPUT_QUEUE_BASE 0X48
#define AUDIO_FIR_FILTER_QUEUE_BASE 0X4C
