...
#ifndef __GEMM_2_BLOCK_HPP__
#define __GEMM_2_BLOCK_HPP__
...
class gemm_2_block : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemm_2_block);
    gemm_2_block(const sc_module_name& name)
