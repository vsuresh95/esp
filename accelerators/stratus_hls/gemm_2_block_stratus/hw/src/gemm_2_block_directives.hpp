...
#ifndef __GEMM_2_BLOCK_DIRECTIVES_HPP__
#define __GEMM_2_BLOCK_DIRECTIVES_HPP__

#if (DMA_WIDTH == 32)
#define DMA_BEAT_PER_WORD 1
#define DMA_WORD_PER_BEAT 1
#define PLM_IN_NAME "gemm_2_block_plm_block_in_dma32"
#define PLM_OUT_NAME "gemm_2_block_plm_block_out_dma32"
#elif (DMA_WIDTH == 64)
#define DMA_BEAT_PER_WORD 1
#define DMA_WORD_PER_BEAT 2
#define PLM_IN_NAME "gemm_2_block_plm_block_in_dma64"
#define PLM_OUT_NAME "gemm_2_block_plm_block_out_dma64"
#endif
...
#endif /* __GEMM_2_BLOCK_DIRECTIVES_HPP_ */
