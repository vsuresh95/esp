...
void system_t::load_memory()
{
    ...
    in_words_adj = 256*256*batch_size;
    out_words_adj = 1;
#else
    in_words_adj = round_up(256*256*batch_size, DMA_WORD_PER_BEAT);
    out_words_adj = round_up(1, DMA_WORD_PER_BEAT);
#endif
    ...
    for (int i = 0; i < 1; i++)
        for (int j = 0; j < 256*256*batch_size; j++)
