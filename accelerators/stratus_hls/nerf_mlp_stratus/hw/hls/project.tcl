...
#
define_hls_module nerf_mlp ../src/nerf_mlp.cpp
...
foreach dma [list 32 64] {
    ...
    define_sim_config "BEHAV_DMA$dma" "nerf_mlp BEH" "tb TESTBENCH_DMA$dma" -io_config IOCFG_DMA$dma -argv $DEFAULT_ARGV
	...
	if {$TECH_IS_XILINX == 1} {
	    ...
	    define_sim_config "$cname\_V" "nerf_mlp RTL_V $cname" "tb TESTBENCH_DMA$dma" -io_config IOCFG_DMA$dma -argv $DEFAULT_ARGV
	}
    }
}
