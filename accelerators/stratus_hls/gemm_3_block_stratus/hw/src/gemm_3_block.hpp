...
#ifndef __GEMM_3_BLOCK_HPP__
#define __GEMM_3_BLOCK_HPP__

#include "gemm_3_block_conf_info.hpp"
#include "gemm_3_block_debug_info.hpp"

#include "esp_templates.hpp"

#include "gemm_3_block_directives.hpp"
...
class gemm_3_block : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemm_3_block);
    gemm_3_block(const sc_module_name& name)
