...
#ifndef __GEMM_4_2D_BLOCK_HPP__
#define __GEMM_4_2D_BLOCK_HPP__

#include "gemm_4_2d_block_conf_info.hpp"
#include "gemm_4_2d_block_debug_info.hpp"

#include "esp_templates.hpp"

#include "gemm_4_2d_block_directives.hpp"
...
class gemm_4_2d_block : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemm_4_2d_block);
    gemm_4_2d_block(const sc_module_name& name)
