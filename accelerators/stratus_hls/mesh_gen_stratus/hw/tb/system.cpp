...
void system_t::config_proc()
{
    ...
    load_memory();
    {
        ...
        /* <<--params-->> */
        config.num_hash_table = num_hash_table;
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - mesh_gen");
        ...
        ESP_REPORT_TIME(end_time, "END - mesh_gen");
...
void system_t::load_memory()
{
...
#else
    in_words_adj = round_up(num_hash_table, DMA_WORD_PER_BEAT);
    out_words_adj = round_up(num_hash_table, DMA_WORD_PER_BEAT);
#endif
    ...
    for (int i = 0; i < 1; i++)
        for (int j = 0; j < num_hash_table; j++)
