...
#ifndef __GEMM_6_2D_BLOCK_HPP__
#define __GEMM_6_2D_BLOCK_HPP__
...
public:
    // Constructor
    SC_HAS_PROCESS(gemm_6_2d_block);
    gemm_6_2d_block(const sc_module_name& name)
