...
#include "asi_vitdodec_functions.hpp"

// Processes

void asi_vitdodec::load_input()
{
...
void asi_vitdodec::store_output()
{
    // Reset
    {
...
void asi_vitdodec::compute_kernel()
{
    // Reset
    {
...
void asi_vitdodec::asi_controller(){
    {
