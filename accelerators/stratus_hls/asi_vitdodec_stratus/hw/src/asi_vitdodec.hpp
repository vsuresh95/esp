...
#ifndef __ASI_VITDODEC_HPP__
#define __ASI_VITDODEC_HPP__
...
class asi_vitdodec : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    void asi_controller();
    // Constructor
    SC_HAS_PROCESS(asi_vitdodec);
    asi_vitdodec(const sc_module_name& name)
