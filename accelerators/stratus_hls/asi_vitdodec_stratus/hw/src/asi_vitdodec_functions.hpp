...
inline void asi_vitdodec::store_done_req()
{
...
inline void asi_vitdodec::store_done_ack()
{
...
inline void asi_vitdodec::load_done_req()
{
...
inline void asi_vitdodec::load_done_ack()
{
...
inline void asi_vitdodec::load_next_tile_req()
{
...
inline void asi_vitdodec::load_next_tile_ack()
{
...
inline void asi_vitdodec::compute_done_req()
{
...
inline void asi_vitdodec::compute_done_ack()
{
