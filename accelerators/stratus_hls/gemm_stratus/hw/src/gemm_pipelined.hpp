...
#ifndef __GEMM_PIPELINED_HPP__
#define __GEMM_PIPELINED_HPP__
...
public:
        ...
        , compute_to_output("compute_to_output")
    {
        ...
        /* <<--plm-bind-->> */
        HLS_MAP_plm(plm_in_1_ping, PLM_IN_NAME);
        HLS_MAP_plm(plm_in_1_pong, PLM_IN_NAME);
        HLS_MAP_plm(plm_in_2_ping, PLM_IN_NAME);
        HLS_MAP_plm(plm_in_2_pong, PLM_IN_NAME);
    ...
    sc_dt::sc_int<DATA_WIDTH> plm_in_1_ping[PLM_IN_WORD];
    sc_dt::sc_int<DATA_WIDTH> plm_in_1_pong[PLM_IN_WORD];
    sc_dt::sc_int<DATA_WIDTH> plm_in_2_ping[PLM_IN_WORD];
    sc_dt::sc_int<DATA_WIDTH> plm_in_2_pong[PLM_IN_WORD];
