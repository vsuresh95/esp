...
int main(int argc, char * argv[])
{
	...
	n = 0;
	{
		...
		///////////////////////////////////////////////////////
		iowrite32(dev, ADD_LOGN_SAMPLES_REG_0, logn_samples);
		iowrite32(dev, ADD_DO_SHIFT_REG_0, do_shift);
		iowrite32(dev, ADD_DO_INVERSE_REG_0, do_inverse);
		iowrite32(dev, ADD_INPUT_QUEUE_BASE_0, input_valid_offset_0);
		iowrite32(dev, ADD_OUTPUT_QUEUE_BASE_0, output_valid_offset_0);
		iowrite32(dev, ADD_CONTEXT_NPRIO_0, 1);
		iowrite32(dev, ADD_SCHED_PERIOD, 0x10000);
		iowrite32(dev, PT_ADDRESS_REG_0, (unsigned long long) ptable0);
		iowrite32(dev, ADD_VALID_CONTEXTS, 0x1);
		...
		///////////////////////////////////////////////////////
		iowrite32(dev, ADD_LOGN_SAMPLES_REG_1, logn_samples);
		iowrite32(dev, ADD_DO_SHIFT_REG_1, do_shift);
		iowrite32(dev, ADD_DO_INVERSE_REG_1, do_inverse);
		iowrite32(dev, ADD_INPUT_QUEUE_BASE_1, input_valid_offset_1);
		iowrite32(dev, ADD_OUTPUT_QUEUE_BASE_1, output_valid_offset_1);
		iowrite32(dev, ADD_CONTEXT_NPRIO_1, 1);
		iowrite32(dev, PT_ADDRESS_REG_1, (unsigned long long) ptable1);
		iowrite32(dev, ADD_VALID_CONTEXTS, 0x3);
		...
		///////////////////////////////////////////////////////
		iowrite32(dev, ADD_LOGN_SAMPLES_REG_2, logn_samples);
		iowrite32(dev, ADD_DO_SHIFT_REG_2, do_shift);
		iowrite32(dev, ADD_DO_INVERSE_REG_2, do_inverse);
		iowrite32(dev, ADD_INPUT_QUEUE_BASE_2, input_valid_offset_2);
		iowrite32(dev, ADD_OUTPUT_QUEUE_BASE_2, output_valid_offset_2);
		iowrite32(dev, ADD_CONTEXT_NPRIO_2, 1);
		iowrite32(dev, PT_ADDRESS_REG_2, (unsigned long long) ptable2);
		iowrite32(dev, ADD_VALID_CONTEXTS, 0x7);
		...
		///////////////////////////////////////////////////////
		iowrite32(dev, ADD_VALID_CONTEXTS, 0x5);
		...
		/// Configure second context
		///////////////////////////////////////////////////////
		iowrite32(dev, ADD_LOGN_SAMPLES_REG_3, logn_samples);
		iowrite32(dev, ADD_DO_SHIFT_REG_3, do_shift);
		iowrite32(dev, ADD_DO_INVERSE_REG_3, do_inverse);
		iowrite32(dev, ADD_INPUT_QUEUE_BASE_3, input_valid_offset_3);
		iowrite32(dev, ADD_OUTPUT_QUEUE_BASE_3, output_valid_offset_3);
		iowrite32(dev, ADD_CONTEXT_NPRIO_3, 1);
		iowrite32(dev, PT_ADDRESS_REG_3, (unsigned long long) ptable3);
		iowrite32(dev, ADD_VALID_CONTEXTS, 0xD);
