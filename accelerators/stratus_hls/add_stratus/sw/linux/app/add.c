...
int main(int argc, char **argv)
{
    ...
    add_cfg_000[0].esp.coherence = coherence;
	add_cfg_000[0].spandex_conf = spandex_config.spandex_reg;
	...
	add_cfg_000[0].input_queue_base = input_valid_offset;
	add_cfg_000[0].output_queue_base = output_valid_offset;
    ...
    add_cfg_000[0].esp.start_stop = 1;
