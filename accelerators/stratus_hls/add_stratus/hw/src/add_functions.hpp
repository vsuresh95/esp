...
inline void add::fft2_bit_reverse(unsigned int offset, unsigned int n, unsigned int bits)
{
...
inline void add::fft2_do_shift(unsigned int offset, unsigned int num_samples, unsigned int logn_samples)
{
