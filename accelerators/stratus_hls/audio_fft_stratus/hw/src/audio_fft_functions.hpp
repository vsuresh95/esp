...
inline void audio_fft::fft2_bit_reverse(unsigned int offset, unsigned int n, unsigned int bits)
{
...
inline void audio_fft::fft2_do_shift(unsigned int offset, unsigned int num_samples, unsigned int logn_samples)
{
...
inline void audio_fft::compute_load_ready_handshake()
{
    {
...
inline void audio_fft::load_compute_ready_handshake()
{
    {
...
inline void audio_fft::compute_store_ready_handshake()
{
    {
...
inline void audio_fft::store_compute_ready_handshake()
{
    {
...
inline void audio_fft::compute_load_done_handshake()
{
    {
...
inline void audio_fft::load_compute_done_handshake()
{
    {
...
inline void audio_fft::compute_store_done_handshake()
{
    {
...
inline void audio_fft::store_compute_done_handshake()
{
    {
...
inline void audio_fft::compute_util_ready_handshake()
{
    {
...
inline void audio_fft::util_compute_ready_handshake()
{
    {
...
inline void audio_fft::compute_util_done_handshake()
{
    {
...
inline void audio_fft::util_compute_done_handshake()
{
    {
