...
#ifndef __GEMM_1_SPARSE_HPP__
#define __GEMM_1_SPARSE_HPP__
...
#define PLM_IN_RES 192

class gemm_1_sparse : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemm_1_sparse);
    gemm_1_sparse(const sc_module_name& name)
    ...
    sc_dt::sc_int<DATA_WIDTH> plm_in_res[PLM_IN_RES];

};


#endif /* __GEMM_1_SPARSE_HPP__ */
