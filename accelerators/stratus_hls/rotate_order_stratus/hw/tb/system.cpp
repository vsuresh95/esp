...
void system_t::config_proc()
{
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - rotate_order");
        ...
        ESP_REPORT_TIME(end_time, "END - rotate_order");
...
#else
    in_words_adj = round_up(16 * block_size, DMA_WORD_PER_BEAT);
    out_words_adj = round_up(16 * block_size, DMA_WORD_PER_BEAT);
#endif
